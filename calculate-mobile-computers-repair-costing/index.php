...
<form method="post" action="t2.html" id='form1' style='    margin-top: 55px;'>
...
<input name="repair_type" id='repair_type' class='input1' placeholder='e.g screen,speaker,lcd etc' >

<!-- <select  name="repair_type" id='repair_type' style="    width: 70%;    margin-bottom: 33px;
    color: black;font-size:12px;display:none1;
...
<input type="button" name="" onclick='make_seo_link()' class='submit2' value="Calculate Cost">


<input type="submit" value='GET PRICING' name="get_rate" id='get_rate' style='display:none' class='submit2'>
...
// make trhye seo friendly l.ink over herer e

function make_seo_link()
{
...
if(repair_type=='')
{
// show all of the device costing ===================================================================



// seo string shud be if user has not choseen any ofg the problem desctreiption over here 
// KEYWORD: all-item-repair-for-apple-iphone6

var theseolink=encodeURI('all-item-repair-costing-for-'+brandname+'-'+modelname);


var theseolink=theseolink.replace("%20","");
var theseolink=theseolink.replace("%20","");
var theseolink=theseolink.replace("%20","");
var theseolink=theseolink.replace("%20","");
var theseolink=theseolink.replace("%20","");
...
document.getElementById('form1').action="../all/?"+theseolink;

document.getElementById('get_rate').click();
...
// SEO STRING WILL BE : screen-repair-costing-for-apple-iphone-5C

var theseolink=encodeURI(repair_type+'-repair-costing-for-'+brandname+'-'+modelname);
